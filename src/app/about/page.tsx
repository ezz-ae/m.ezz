...
const notebooks = [
    ...
    { id: 'omega', tag: 'PROTOTYPE · PHYSICS' },
];
    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden pt-24 font-pt-sans">
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <Section className="text-center max-w-4xl mx-auto">
          <h1 className="font-playfair text-4xl md:text-5xl font-bold text-foreground">About the Architect</h1>
          <p className="text-lg md:text-xl text-muted-foreground mt-2">Intelligence System Architect & Cognitive Evolution Theorist</p>
        </Section>
        ...
        <Section className="mt-20 md:mt-24 text-center max-w-3xl mx-auto">
            ...
            >
                <p className="text-xl md:text-2xl text-primary leading-relaxed italic">
                    “The work is at the infrastructure layer—legal automation, digital governance, economic models, and AI OS concepts—derived from high-resolution cognitive observation, not academic study.”
                </p>
            </motion.div>
        </Section>
        ...
        <Section className="mt-20 md:mt-24 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="bg-card p-6 rounded-lg border border-border">
             ...
             <div className="bg-card p-6 rounded-lg border border-border">
                ...
                <p className="text-sm text-muted-foreground mt-1">Operating by discovery, not by rules. Following the structure of thought itself to derive new computational laws.</p>
            </div>
             <div className="bg-card p-6 rounded-lg border border-border">
        ...
        <Section className="mt-20 md:mt-24 max-w-3xl mx-auto text-center">
             <h2 className="text-2xl md:text-3xl font-light text-foreground mb-4 font-playfair">The Origin Narrative</h2>
             <p className="text-base md:text-lg text-muted-foreground">
                The journey began in advertising and medical awareness campaigns, leading to an obsession with personalisation and behavioural change. This evolved into architecting systems of influence, and ultimately, into the core inquiry: how does the human mind actually work, and how can we build systems that are truly aligned with it?
             </p>
        </Section>
        
        <Section className="mt-20 md:mt-24">
             <h2 className="text-2xl md:text-3xl font-light text-foreground mb-8 text-center font-playfair">The AIXSELF Living Notebooks</h2>
