      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <Section className="mt-20 md:mt-24 max-w-3xl mx-auto">
            <div className="space-y-12">
                <div>
                    <h2 className="text-2xl font-light text-neutral-200 flex items-center gap-3 mb-4"><BrainCircuit size={24} /> The New Foundation</h2>
                    <p className="text-sm md:text-base text-neutral-400">
                        The core breakthrough is a new understanding of cognition itself: The human mind is a <strong className="text-white">state-based generative engine</strong>, not a storage-based retrieval machine. Memory is reconstruction, not recall. Forgetting is a feature, not a bug. Identity is the continuity of inference, not a collection of memories.
                    </p>
                </div>
                <div>
