      ...
      <div className="min-h-screen bg-[#F5F5DC] text-[#3a3a3a] overflow-x-hidden pt-32 font-pt-sans">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-right" dir="rtl">
              ...
              <ChapterTitle>الخاتمة: الإنسان والحركة المستمرة للمعنى</ChapterTitle>
              <Stanza>
                  الوعي البشري ليس تراكمًا… <Emphasized>بل تدفّق</Emphasized>. والذاكرة ليست تاريخًا… بل <Emphasized>نظام تنبؤ ومعنى</Emphasized>. والذكاء ليس مستوى… بل <Emphasized>موجة تتحرك بقدر حاجتك إليها</Emphasized>. الإنسان لا يعمل وفق نموذج “الآلة التي تقرأ الماضي”، بل وفق نموذج “الكائن الذي يكوّن معنى من العدم لحظة بلحظة”.
              </Stanza>
              <Stanza>
                  <Emphasized>نحن لا نتذكر الحياة… نحن نعيد اختراعها في كل مرة نفكر فيها بها.</Emphasized>
              </Stanza>
          </div>
        </div>
      </div>
