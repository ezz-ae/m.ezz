    ...
    <div className="w-full max-w-2xl mx-auto bg-black border border-gray-800 p-6 rounded-lg font-mono text-sm">
      ...
      <div className="flex gap-2 mb-8">
        <input
          ...
          className="flex-1 bg-gray-900 text-white p-3 rounded border border-gray-700 focus:border-green-500 outline-none"
          value={intent}
        ...
        <button
          ...
          className="px-6 bg-green-600 text-white font-bold uppercase hover:bg-green-500 disabled:bg-gray-600 disabled:cursor-not-allowed"
      ...
      <div className="h-40">
        <AnimatePresence mode="wait">
            {calculating ? (
                <motion.div 
                    key="calculating"
                    className="text-center text-green-500 animate-pulse py-10"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    exit={{ opacity: 0 }}
                >
                ...
                >
                    <div className="grid grid-cols-3 gap-4 text-center">
                        <div className="bg-gray-900 p-4 rounded border border-gray-800">
                            ...
                            <div className="text-2xl text-white font-bold">{result.certainty}</div>
                        </div>

                        <div className="bg-gray-900 p-4 rounded border border-gray-800">
                            <div className="text-xs text-gray-500 mb-1">SPEED</div>
                            <div className="text-2xl text-white font-bold">{result.speed}</div>
                        </div>

                        <div className="bg-gray-900 p-4 rounded border border-green-900/30">
                            <div className="text-xs text-gray-500 mb-1">INK MINED</div>
                            <div className="text-2xl text-green-400 font-bold">+{result.ink_cost}</div>
                        </div>
                        
                        <div className="col-span-3 mt-4 p-3 bg-green-900/20 border border-green-500/30 text-green-400">
                            STATUS: {result.match}
                        </div>
                    </div>
                </motion.div>
