  ...
  return (
    <article className="prose prose-invert max-w-3xl mx-auto py-16 space-y-12">
      ...
      <Section>
        ...
        <ScrollParagraph className="text-2xl text-center font-code tracking-widest py-4">
        ...
        <ul>
          ...
          <ScrollParagraph as="li">فكر (again) — the whole layer of thought</ScrollParagraph>
        </ul>
      ...
      <Section>
        ...
        <ul>
          ...
          <ScrollParagraph as="li">freeze you in your worst version and keep treating you as that,</ScrollParagraph>
          <ScrollParagraph as="li">
