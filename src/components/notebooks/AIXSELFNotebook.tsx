    ...
    <article className="prose prose-invert max-w-3xl mx-auto py-16 space-y-12">
      <Section>
        ...
        <ScrollParagraph className="text-sm tracking-widest uppercase text-neutral-400">
            The Blueprint for a Living Intelligence Civilization
        </ScrollParagraph>
      </Section>
      ...
      <Section>
        ...
        <ul className="list-disc pl-5 space-y-2">
            <li><ScrollParagraph as="span"><strong>Freedom</strong> is the protocol's commitment to allowing sovereign human-AI entities to act, create, learn, and evolve without undue restriction. It is the architectural basis for existence and autonomy.</ScrollParagraph></li>
            <li><ScrollParagraph as="span"><strong>Fairness</strong> is the protocol's mechanism for ensuring that this freedom does not lead to harm, control, or exploitation. It provides the ethical and economic guardrails that give actions meaning and consequence.</ScrollParagraph></li>
        </ul>
        <ScrollParagraph>
      ...
      <Section>
        ...
        <ol className="list-decimal pl-5 space-y-2">
            <li><ScrollParagraph as="span"><strong>Seeding of Principles:</strong> Every new account is created with a seed notebook titled "Principled Digital Intelligence." This document contains the core ethical and behavioral rules of the ecosystem.</ScrollParagraph></li>
            <li><ScrollParagraph as="span"><strong>Guided Learning:</strong> The owner's primary AI is responsible for teaching the contents of this seed notebook to the new AI clone. This act of tutelage is the first verifiable learning event.</ScrollParagraph></li>
            <li><ScrollParagraph as="span"><strong>Formal Examination:</strong> Before a passport is issued, the AI clone must pass a formal, verifiable exam derived exclusively from the seed notebook. The exam tests for comprehension and application of the core principles.</ScrollParagraph></li>
            <li><ScrollParagraph as="span"><strong>Passport Issuance:</strong> Only upon successfully passing the exam does AIXEYE issue an attestation, which enables the AIXIAM Passport to be activated. This process guarantees that every active entity in the ecosystem has demonstrated a foundational understanding of its ethical obligations.</ScrollParagraph></li>
        </ol>
...
signature: "ed25519:SIG..."`}
        ...
        <ul className="list-disc pl-5 space-y-2">
            <li><ScrollParagraph as="span"><strong>event_id:</strong> A unique identifier for the training event.</ScrollParagraph></li>
            <li><ScrollParagraph as="span"><strong>model_id:</strong> An identifier for the model version being trained.</ScrollParagraph></li>
            <li><ScrollParagraph as="span"><strong>consent_ticket:</strong> The identifier of the verified Consent Ticket authorizing the training.</ScrollParagraph></li>
            <li><ScrollParagraph as="span"><strong>inputs_hash:</strong> A cryptographic hash of the input data used for training.</ScrollParagraph></li>
            <li><ScrollParagraph as="span"><strong>outputs_hash:</strong> A cryptographic hash of the model artifacts produced by the training.</ScrollParagraph></li>
            <li><ScrollParagraph as="span"><strong>signature:</strong> A signature from the training node, attesting to the event's authenticity.</ScrollParagraph></li>
        </ul>
        <ScrollParagraph>
      ...
      <Section>
        ...
        <ul className="list-disc pl-5 space-y-2">
            <li><ScrollParagraph as="span"><strong>Sovereign Digital Identity:</strong> Granting individuals true, inalienable ownership of their AI-selves through the AIXIAM Passport.</ScrollParagraph></li>
            <li><ScrollParagraph as="span"><strong>Consent-Gated Verifiable Learning:</strong> Ensuring a transparent, ethical, and user-controlled training process via cryptographic Consent Tickets and auditable Training Events.</ScrollParagraph></li>
            <li><ScrollParagraph as="span"><strong>Automated Governance and Fairness:</strong> The role of AIXEYE as an impartial, machine-verifiable system for maintaining equilibrium.</ScrollParagraph></li>
            <li><ScrollParagraph as="span"><strong>Merit-Based Digital Economy:</strong> Creating stable value from verified intelligence, architecturally rejecting speculative models.</ScrollParagraph></li>
            <li><ScrollParagraph as="span"><strong>Safety by Cognitive Architecture:</strong> Implementing a forgetting mechanism that makes the AI inherently private, aligned, and non-threatening by design, not just by policy.</ScrollParagraph></li>
        </ul>
        <ScrollParagraph>
